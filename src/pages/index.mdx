...
**Table:** Variation-aware description without support indicator and with three variant support indicators (Language, Percentage, Source).  
Agreements (<span style="background-color:#ccffcc;">green</span>), disagreements (<span style="background-color:#ffcccc;">red</span>), and unique mentions (<span style="background-color:#cce5ff;">blue</span>) are highlighted.
